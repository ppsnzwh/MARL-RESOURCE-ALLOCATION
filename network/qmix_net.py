...
class QMixNet(nn.Module):
    def __init__(self, args):
        ...
        if args.two_hyper_layers:
            self.hyper_w1 = nn.Sequential(nn.Linear(args.state_shape, args.hyper_hidden_dim),  # 括号里的都是数字
                                          nn.ReLU(),
            ...
            self.hyper_w1 = nn.Linear(args.state_shape, args.n_agents * args.qmix_hidden_dim)  # state_shape=98  n_agents=5  qmix_hidden_dim=64
            # 经过hyper_w2得到(经验条数, 1)的矩阵

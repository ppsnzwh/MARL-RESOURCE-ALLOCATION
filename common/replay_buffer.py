...
class ReplayBuffer:
    def __init__(self, args):
        self.args = args
        self.n_actions = self.args.n_actions  # 2
        self.n_agents = self.args.n_agents  # 3
        self.state_shape = self.args.state_shape  # 8
        self.obs_shape = self.args.obs_shape  # 4
        self.size = self.args.buffer_size  # 5000
        self.episode_limit = self.args.episode_limit  # 70
        # memory management
        self.current_idx = 0
        self.current_size = 0
